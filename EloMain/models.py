...
class Club(models.Model):
    ...
    championship = models.ForeignKey(
        Championship, on_delete=models.CASCADE, related_name="championship", verbose_name="Чемпионат", default=-1
    )
...
class Game(models.Model):
    ...
    tournament = models.ForeignKey(
        Championship, on_delete=models.CASCADE, related_name="tournament", verbose_name="Турнир", default=-1
    )
    home_team = models.ForeignKey(
        Club, on_delete=models.DO_NOTHING, related_name="home_team", verbose_name="Хозяева", blank=True, null=True
    )
    away_team = models.ForeignKey(
        Club, on_delete=models.DO_NOTHING, related_name="away_team", verbose_name="Гости", blank=True, null=True
    )
...
class Change(models.Model):
    ...
    club = models.ForeignKey(
        Club, on_delete=models.DO_NOTHING, related_name="club", verbose_name="Клуб", blank=True, null=True
    )
